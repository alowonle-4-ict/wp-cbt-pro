...
<div class="wrap wpcbtpro-wrap">
    <h1 class="wp-heading-inline"><?php esc_html_e('Programming Questions', 'wp-cbt-pro'); ?></h1>
    ...
    <?php if (empty($questions)): ?>
        <p><em><?php esc_html_e('No programming questions yet.', 'wp-cbt-pro'); ?></em></p>
    <?php else: ?>
    <table class="widefat striped">
        <thead>
            <tr>
                <th><?php esc_html_e('Problem', 'wp-cbt-pro'); ?></th>
        ...
        <tbody>
            <?php foreach ($questions as $question):
                $editUrl = add_query_arg(['page' => 'wpcbtpro-programming', 'action' => 'edit', 'id' => $question['id']], admin_url('admin.php'));
                $deleteUrl = wp_nonce_url(add_query_arg(['page' => 'wpcbtpro-programming', 'action' => 'delete', 'id' => $question['id']], admin_url('admin.php')), 'wpcbtpro_delete_programming_' . $question['id']);
            ?>
            <tr>

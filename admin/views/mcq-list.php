 ...
 * @var string $addSingleChoiceUrl
 * @var string $addTrueFalseUrl
 */
if (!defined('ABSPATH')) {
    exit;
}
...
<div class="wrap wpcbtpro-wrap">
    <h1 class="wp-heading-inline"><?php esc_html_e('Questions', 'wp-cbt-pro'); ?></h1>
    <a href="<?php echo esc_url($addSingleChoiceUrl); ?>" class="page-title-action"><?php esc_html_e('Add Single Choice', 'wp-cbt-pro'); ?></a>
    <a href="<?php echo esc_url($addTrueFalseUrl); ?>" class="page-title-action"><?php esc_html_e('Add True/False', 'wp-cbt-pro'); ?></a>
    ...
    <p class="description"><?php esc_html_e('Single choice and true/false questions built directly in the question bank. Questions from a Word import appear here too.', 'wp-cbt-pro'); ?></p>

    <?php if (empty($questions)): ?>
        <p><em><?php esc_html_e('No questions yet.', 'wp-cbt-pro'); ?></em></p>
    <?php else: ?>
    <table class="widefat striped">
        ...
        <tbody>
            <?php foreach ($questions as $question):
                $editUrl = add_query_arg(['page' => 'wpcbtpro-questions', 'action' => 'edit', 'id' => $question['id']], admin_url('admin.php'));
                $deleteUrl = wp_nonce_url(add_query_arg(['page' => 'wpcbtpro-questions', 'action' => 'delete', 'id' => $question['id']], admin_url('admin.php')), 'wpcbtpro_delete_mcq_' . $question['id']);
            ?>
            <tr>
                ...
                <td><?php echo esc_html($typeLabels[$question['type']] ?? $question['type']); ?></td>
